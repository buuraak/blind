...
export function SiteHeader({
  ...
  /* The panel covers the viewport, so Escape is the expected way out; without it the
     only exit is hitting the toggle again. This moved here with the panel itself — it
     was written against the inline nav in blind-by-glamour.tsx before the extraction. */
  useEffect(() => {
    if (!navOpen) return;
